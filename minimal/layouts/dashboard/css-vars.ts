...
import type { SettingsState } from '@minimal/components/settings';

import { varAlpha } from 'minimal-shared/utils';

import { bulletColor } from '@minimal/components/nav-section';
    ...
    case 'apparent':
      return {
        layout: {
          ...
          // '--layout-nav-horizontal-bg': varAlpha(palette.background.default, 0.96),
