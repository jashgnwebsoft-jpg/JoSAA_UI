...
import { useBranchWiseCollegeListQuery } from '../api/hooks';
import { TabPanel } from '@mui/lab';
import { Box, TextField } from '@mui/material';
import { BranchWiseCollegeistResponse } from '../types';
...
const BranchWiseCollegeListPage = () => {
  ...
  const { postModel, handlePagination, handleFiltering } = useBranchWiseCollegeListStore();
  const { data: collegeOptions } = useCollegeTypeOptions();
  const { data, totalRecords } = useBranchWiseCollegeListQuery(postModel);
